...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<form action="validateUser" method="post" class="form form-horizontal">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">手机号：</label>
				<div class="formControls col-xs-8 col-sm-9">${user.mobile }</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">证件照片：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<img alt="" src="${user.img }" width="380px;" height="auto;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">是否通过：</label>
				<div class="formControls col-xs-8 col-sm-3">
					<select class="input-text" name="validate">
